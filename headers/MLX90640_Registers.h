...
enum {
    ...
    MLX90640_EEPROM_LAST_USED = 0x273F,
    MLX90640_EEPROM_END = 0x2740,
    MLX90640_EEPROM_LENGTH = MLX90640_EEPROM_LAST_USED - MLX90640_EEPROM_START,

    MLX90640_RAM_PIXELS_START = 0x400,

    MLX90640_RAM_PIXELS_END = MLX90640_RAM_PIXELS_START + MLX90640_PIXEL_TOTAL,

    MLX90640_RAM_AUX_DATA_START = 0x7000,
    MLX90640_RAM_AUX_DATA_LENGTH = 64,
